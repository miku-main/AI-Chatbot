...
function addAnswerSection(question) {
    ...
    answerSection.innerHTML = getLoadingSvg();
...
function getAnswer(question, id) {
    ...
    .catch(err => {
        ...
        if (errorEl) {
            errorEl.innerText = "Error getting response.";
        }
    })
    .finally(() => {
...
<circle fill="#137A7F" stroke="#137A7F" stroke-width="15" r="15" cx="40" cy="65">
<animate attributeName="cy" calcMode="spline" dur="2" values="65;135;65;" 
keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.4"></animate></circle>
<circle fill="#137A7F" stroke="#137A7F" stroke-width="15" r="15" cx="100" cy="65">
<animate attributeName="cy" calcMode="spline" dur="2" values="65;135;65;" 
keySplines=".5 0 .5 1;.5 0 .5 1" repeatCount="indefinite" begin="-.2"></animate></circle>
<circle fill="#137A7F" stroke="#137A7F" stroke-width="15" r="15" cx="160" cy="65">
<animate attributeName="cy" calcMode="spline" dur="2" values="65;135;65;" 
